  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Identificar los diferentes elementos conceptuales sobre caracterización poblacional, partiendo de las características inherentes a los eventos en el sector del deporte.
